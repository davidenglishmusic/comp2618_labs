// Lab 1 Driver Program - used to test the 3 classes
...
int main()
{
	...
	// Count will be 3 in statement below because a Shape object is contained
	//     within each Circle and Cylinder object as well.
	cout << "The Shape object count is: " << Shape::getObjectCount() << "\n";
	...
	// Dynamically create 2 Shape objects
	Shape * shpePtr2 = new Shape;
	Shape & shpeRef2 = *new Shape; 

	// The count should now be 5
	cout << "The Shape object count is: " << Shape::getObjectCount() << "\n";
	...
	//The count should now be 3 again.
	cout << "The Shape object count is: " << Shape::getObjectCount() << "\n\n";
	...
	// Let us see what happens when we ...

	shpeObj = cyldObj;  // Assign the Cylinder class object to the 
	                    //     Shape class object

	cout << "When we invoke the shpeObj with the Area() method, the result is: " <<
		shpeObj.Area() << '\n';
	cout << "When we invoke the shpePtr with the Area() method, the result is: " <<
		shpePtr->Area() << '\n';
	cout << "When we invoke the shpeRef with the Area() method, the result is: " <<
		shpeRef.Area() << '\n' << endl;
